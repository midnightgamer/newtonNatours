         ...
         function (require, module, exports) {
            ...
            require('./_fix-re-wks')('replace', 2, function (
               ...
               function getSubstitution(
                  ...
                  return $replace.call(replacement, symbols, function (
                     match,
                     ch
                  ) {
                     var capture;
            ...
            require('./_fix-re-wks')('split', 2, function (
               ...
               if (
                  ...
                  internalSplit = function (separator, limit) {
                     ...
                     var lastLastIndex = 0;
                     var splitLimit =
                        limit === undefined ? MAX_UINT32 : limit >>> 0;
            ...
            if (!$typed.ABV) {
               ...
               redefineAll($DataView[PROTOTYPE], {
                  ...
                  getUint32: function getUint32(
                     ...
                     return (
                        unpackI32(get(this, 4, byteOffset, arguments[1])) >>> 0
                     );
                  },
         ...
         function (require, module, exports) {
            ...
            $export($export.S + $export.F * !$typed.CONSTR, ARRAY_BUFFER, {
               ...
               isView: function isView(it) {
                  return (
                     ($isView && $isView(it)) || (isObject(it) && VIEW in it)
                  );
               },
            });
               ...
               getConstructor: function (wrapper, NAME, IS_MAP, ADDER) {
                  ...
                  redefineAll(C.prototype, {
                     ...
                     delete: function (key) {
                        ...
                        if (data === true)
                           return uncaughtFrozenStore(validate(this, NAME))[
                              'delete'
                           ](key);
                        return (
                     ...
                     has: function has(key) {
                        ...
                        var data = getWeak(key);
                        if (data === true)
                           return uncaughtFrozenStore(validate(this, NAME)).has(
                              key
                           );
