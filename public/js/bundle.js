...
})(
   {
      ...
      um4Z: [
         function (require, module, exports) {
            ...
            module.exports = require('./_core').getIteratorMethod = function (
               o
            ) {
      ...
      HXfT: [
         function (require, module, exports) {
            ...
            r(r.S, 'Math', {
               hypot: function (r, a) {
                  for (
                     var e, h, n = 0, o = 0, u = arguments.length, M = 0;
                     o < u;
               ...
               q = function (e) {
                  ...
                  if ('string' == typeof r && r.length > 2) {
                     ...
                     if (43 === o || 45 === o) {
                        ...
                        for (
                           var u, s = r.slice(2), f = 0, _ = s.length;
                           f < _;
                           f++
                        )
               ...
               H = function (e) {
                  v.call(o, function () {
                     ...
                     P
                        ...
                        : (r = o.onrejectionhandled) &&
                          r({ promise: e, reason: e._v });
                  });
               },
               T = function (e) {
                  var r = this;
            ...
            var e = require('./_flags'),
               ...
               n = (function () {
                  var e = /a/,
                     t = /b*/g;
                  return (
                     l.call(e, 'a'), l.call(t, 'a'), 0 !== e[a] || 0 !== t[a]
                  );
               })(),
               o = void 0 !== /()??/.exec('')[1],
               c = n || o;
               ...
               return [
                  ...
                  function (r, t) {
                     ...
                     for (var q = []; ; ) {
                        ...
                        if ((q.push(S), !x)) break;
                        '' === String(S[0]) &&
                           (v.lastIndex = a(s, n(v.lastIndex), b));
                     }
                     ...
                     function (e, l) {
                        ...
                        for (var m = 0, y = 0, w = []; y < o.length; ) {
                           ...
                           if (
                              ...
                              if ((w.push(o.slice(m, y)), w.length === b))
                                 return w;
            ...
            W ||
               (n(
                  (N = function () {
                     ...
                     return (
                        t && z && A(Q, e, { configurable: !0, set: i }), B(e)
                     );
                  })[I],
                  'toString',
                  function () {
         ...
         function (require, module, exports) {
            ...
            if (require('./_descriptors')) {
               var r = require('./_library'),
                  ...
                  Re = function () {
                     for (
                        var e = 0, r = arguments.length, t = je(this, r);
                        r > e;
      ...
      Y0Wb: [
         function (require, module, exports) {
            ...
            var e,
               ...
               g = (module.exports = require('./_collection')(
                  f,
                  v,
                  d,
                  u,
            ...
            module.exports = function (i) {
               return new Promise(function (u, l) {
                  ...
                  if (
                     ...
                     (c.onabort = function () {
                        c &&
                           (l(a('Request aborted', i, 'ECONNABORTED', c)),
                           (c = null));
                     }),
                     (c.onerror = function () {
               ...
               return (
                  ...
                  (n.adapter || t.adapter)(n).then(
                     function (e) {
                        return (
                           s(n),
                           (e.data = r(e.data, e.headers, n.transformResponse)),
                           e
                        );
                     },
                     function (e) {
         ...
         function (require, module, exports) {
            ...
            var e = function (e) {
               ...
               var o = new mapboxgl.Map({
                     container: 'map',
                     style:
                        'mapbox://styles/midnightgamer/ckd17q2co1qeb1ioix5ecf5k2',
                     scrollZoom: !1,
                  }),
                                 ...
                                 switch ((t.prev = t.next)) {
                                    case 0:
                                       return (
                                          ...
                                          (t.next = 3),
                                          (0, e.default)(
                                             '/api/v1/bookings/checkout-session/'.concat(
                                                n
                                             )
                                          )
                                       );
      ...
      Focm: [
         function (require, module, exports) {
            ...
            function u(e, r, s, o, u, t, i) {
               ...
               n.done ? r(c) : Promise.resolve(c).then(o, u);
            }
            function t(e) {
               return function () {
                  var r = this,
            ...
            var i = document.getElementById('map'),
               ...
               d = document.querySelector('#save-data'),
               m = document.querySelector('.form-user-password'),
               a = document.querySelector('#bookTour');
            if (i) {
               var l = i.dataset.locations;
               (l = JSON.parse(l)), (0, r.displayMap)(l);
            }
            n &&
