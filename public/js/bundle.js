...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlkbmlnaHRnYW1lciIsImEiOiJja2QxN2ZucGgwY3ZvMnZsNXUxYjIzc3o3In0.rUiiw6JOJ07NfdO74Qfr5Q';
...
var stripe = Stripe('pk_test_51H9VXXH8UAzj9LgCkkEB00ENpsyq4FedxIEdJMbVpcKAx7nvWkNnTz2cUWWPDavI1DSqZXQBpBVTnVLWxB73Ri3q00T6V5FT4x');
...
var settingsButton = document.querySelector('#save-data');
var passwordForm = document.querySelector('.form-user-password');
var bookButton = document.querySelector('#bookTour'); //Values
//Delegation
